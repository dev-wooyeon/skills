...
각 문서는 단순 설명이 아니라 아래 두 가지를 함께 담습니다.

- 스킬의 역할, 입력, 출력, 관리 포인트를 빠르게 파악할 수 있는 카탈로그
- Codex나 유사한 에이전트에 바로 붙여 넣을 수 있는 실행 프롬프트 템플릿
...
- 이 저장소는 스킬의 목적, 입력, 출력, 관리 포인트와 실행 프롬프트를 함께
  관리합니다.
